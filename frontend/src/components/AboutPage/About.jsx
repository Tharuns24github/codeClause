      ...
      <section className="about-intro">
        ...
        <div className='about-div-img1'>
          ...
          <div className="intro-text">
            <h2>Introduction</h2>
            <p>Eventer is your go-to tool for planning and Any type of  events. From sports activities to concerts, our app makes it easy to organize, track, and execute events smoothly. With Eventer, you can handle everything in one place and ensure your events are a success.</p>
          </div>
        </div>
      </section>
